...
<form:form action="addStudentProcess" modelAttribute="student" method="POST">
<form:hidden path="id"/>
描述:<form:input path="job"/><br/>
截止时间:<form:input path="etime"/><br/>
作业内容:<form:input path=""/><br/>
<form:hidden path="who"/>
<form:hidden path="stime"/>
<form:hidden value="${username}" path="sname"/>
<form:hidden value="${num+1}" path="submit" var="num"/>${num}
<form:hidden value="<%= NowTime %>" path="homework"/>
